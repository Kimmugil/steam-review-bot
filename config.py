...
- ⚙️ **설정 모듈화:** 전광판 속도 및 대기 메시지 리스트 분리
- 🎨 **가독성 개선:** 노션 리포트 내 [긍정/부정] 색상 구분 및 워딩 수정
- 🛡️ **보안 강화:** 에러 로그 내 API 키 노출 방지 로직 적용
"""
