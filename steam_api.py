...
# ── [버그 수정] 중복 선언된 두 번째 ask_followup_question 제거
# 기존에 함수가 2번 정의되어 있어 첫 번째(ui_texts 프롬프트 사용)가 무시되고
# 하드코딩된 두 번째 함수만 실행되는 문제 수정.
# qa_prompt_template 키를 ui_texts.py에서 관리하도록 복원.
