...
TEXTS = {
    ...
    # 💡 [업데이트] 탭 5개로 분리 및 텍스트 변경
    "tab_summary": "📊 주요 평가 요약",
    "tab_news_issue": "📢 최신 소식 및 체크포인트",
    "tab_playtime": "⏱️ 플레이타임별 유저 평가",
    ...
    "trend_all": "**📈 누적 여론 동향**",
    "trend_recent": "**🔥 {} 동향**",
    "date_period_info": "📅 수집 기간: {} (ℹ️ 기준: {})", 

    # 💡 [업데이트] 주요 이슈 픽에 대한 명확한 추출 기준 설명 텍스트 추가!
    "issue_pick_title": "### 🚨 주요 이슈 픽",
    "issue_pick_desc": "💡 최근 동향 집계 기간({}) 내 작성된 리뷰를 중심으로 도출된 핵심 체크포인트입니다.",
    "news_title": "### 📢 최신 소식",
    "no_news": "관련 소식이 없습니다.",
    "category_summary_title": "### 📁 세부 카테고리 평가",
