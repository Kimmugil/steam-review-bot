...
TEXTS = {
    ...
    # ----------------------------------------------------
    # 3. Step 1: 분석 대상 입력 화면 (Input Screen)
    # ----------------------------------------------------
    ...
    # ----------------------------------------------------
    # 5. Step 2: 리포트 검수 화면 (Report Inspect)
    # ----------------------------------------------------
    "step2_title": "리포트 검수",
    ...
    # ----------------------------------------------------
    # 8. Notion 전용 텍스트 (Notion Exporter)
    # ----------------------------------------------------
    ...
    # ----------------------------------------------------
    # 9. Steam API 분석 로직 텍스트 (Steam API)
    # ----------------------------------------------------
    "steam_period_early": "출시 초기",
    "steam_period_early_desc": "출시 직후 민심을 파악하기 위해 최근 3일간의 동향을 분석했습니다.",
    "steam_period_mid": "최근 {}일",
    "steam_period_mid_desc": "오픈 초기 노이즈를 배제하기 위해 출시일의 절반인 최근 {}일간의 동향을 분석했습니다.",
    "steam_period_long": "최근 30일",
    "steam_period_long_desc": "서비스가 안정화된 상태로 최근 30일간의 장기 동향을 분석했습니다.",
