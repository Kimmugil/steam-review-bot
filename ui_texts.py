...
TEXTS = {
    ...
    "main_desc": "탈곡기에 넣고 싶은 게임의 스팀 상점 주소나 App ID를 입력하면, 유저 리뷰를 탈탈 털어 글로벌 민심을 확인할 수 있습니다..",
    ...
    "notion_summary_title": "🎯 전 국가 망라 최종 요약",
    "notion_summary_all": "📈 전체 누적 주요 여론",
    "notion_summary_recent": "🔥 {} 주요 여론",
    "notion_playtime_title": "⏱️ 플레이타임별 민심 교차 분석",
    "notion_region_title": "🗺️ 권역별 세부 평가 분석",
